...
This pattern indicates that the South and select western regions face challenges in accessing healthy food and is saturated with convenient fast food options.
```{r}
# Create datatable
datatable(
  fastfood_map_state |>
