...
Albuquerque, NM (CBSA number 10740) permitted the most new housing units in **`r top_nm_permit$year`**, 
with **`r top_nm_permit$total_permits`** units.
...
# Create an interactive datatable
datatable(high_income, caption = "Average and Total Income by State (2015)")
...
# Leaders by year for NAICS 5182
leaders_5182 <- WAGES |>
...
datatable(leaders_5182_tbl,
  caption = "Yearly leader by employment in NAICS 5182")
```
The last year the NYC CSBA had the most data scientist was **`r nyc_last_year$last_year_led`**.
...
# Create scatterplot
ggplot(employment_joined, aes(x = total_emp, y = health_emp)) +
  geom_point(color = "steelblue") +
  geom_smooth(method = "lm", se = FALSE, color = "darkred") +
  labs(
    title = "Health Care & Social Assistance Employment vs. Total Employment",
    x = "Total Employment",
    y = "Employment in NAICS 62 (Health Care & Social Services)"
  ) +
  theme_minimal()
